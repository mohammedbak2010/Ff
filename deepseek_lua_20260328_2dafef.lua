...
-- Anti Ragdoll المتقدم من K7 / Hulk Hub
        ...
        if hum then
            ...
            if state == Enum.HumanoidStateType.Physics or
               ...
               state == Enum.HumanoidStateType.FallingDown then
                ...
                -- إزالة القيود التي تسبب الراجدول
...
print("H2N V9.8 - Fixed | Enhanced AntiRagdoll | Ragdoll TP stops: L1/R1=0.2, L2/R2=0.15 | All side buttons draggable")