-- H2N V9.9 | Ultimate Edition | Auto Duel Fixed (No Delay) | All Features Working
...
local function LoadEverything()
    ...
    DuelTP.StandPoints = { LEFT = Vector3.new(-466, -6, 114), RIGHT = Vector3.new(-466, -6, 6) }
    if data.Keys then
...
-- ====== AUTO DUEL (تم التعديل - بدون انتظار، مسافة كشف 1.0) ======
...
-- مسافة الكشف: 1.0 (يصل إلى النقطة بدقة)
...
initWPParts()
ApplyLoadedState()
Notify("H2N V9.9 | Auto Duel Fixed (No Delay) | All Features Working")
print("=" .. string.rep("=", 60))
