-- H2N V9.8 | Full Fixed | Anti-Ragdoll Advanced | Auto Dues Working | Full Save
...
-- ====== ANTI RAGDOLL (متطور - يمنع النوك باك والتثبيت) ======
...
local function StartAntiRagdoll()
    ...
    antiRagdollConn = RunService.Heartbeat:Connect(function()
        ...
        if hum then
            ...
            -- كشف الـ Ragdoll أو الـ Knockback
            if state == Enum.HumanoidStateType.Physics or
               ...
               state == Enum.HumanoidStateType.Landed then
                ...
                if tick() - lastRagdollTime > RAGDOLL_COOLDOWN then
                    ...
                    -- إيقاف السرعة العمودية (منع الطيران للسماء)
                    if root then
        ...
        -- إعادة تمكين الـ Motor6D المعطلة
...
-- ====== RAGDOLL TP (مع توقفات R1=0.1, R2=0.2) ======
...
print("H2N V9.8 - Full Fixed | Anti-Ragdoll Advanced | Auto Dues Fixed | Full Save")