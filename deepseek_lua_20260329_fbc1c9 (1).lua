...
-- ====== RAGDOLL TP (مع تأخيرات محددة فقط عند التليبوبورت) ======
...
local function teleportSequence(side)
    ...
    -- Teleport to first point (L1 or R1) with 0.2 second delay
    hrp.CFrame = CFrame.new(points[1])
    task.wait(0.2)
    
    -- Teleport to second point (L2 or R2) with 0.15 second delay
...
initWPParts()
ApplyLoadedState()
Notify("H2N V9.9 | No Delay Auto Duel | No Home Set | Fixed Toggles | TP Delays: L1(0.2s) L2(0.15s)")
print("=" .. string.rep("=", 60))
...
print("✓ Teleport to L1/R1 → 0.2 second wait")
print("✓ Teleport to L2/R2 → 0.15 second wait")
print("✓ Auto Duel starts immediately after TP (no delay)")
print("=" .. string.rep("=", 60))
print("📌 CONTROLS:")
