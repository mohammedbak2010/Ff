-- H2N V9.8 | Fixed | Ragdoll TP with stops | Auto Dues Smooth | Full Save
...
-- دالة لإنشاء الأزرار الجانبية (نفس نظام الأزرار الباقية)
...
-- زر RAGDOLL TP (بنفس نظام الأزرار الباقية)
CreateSideButton("RAGDOLL TP", "right", 2, function() return State.DuelTP end, startDuelTP, stopDuelTP)

-- زر FLOAT (بنفس نظام الأزرار الباقية)
CreateSideButton("FLOAT", "right", 3, function() return State.FloatEnabled end, startFloat, stopFloat)

-- ملاحظة: تم إزالة UNWALK من الأزرار الجانبية كما طلبت
...
print("H2N V9.8 - Fixed | Auto Dues Smooth | Ragdoll TP & FLOAT as normal side buttons | Unwalk removed from side buttons")