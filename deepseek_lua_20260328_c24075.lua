-- H2N V9.8 | FINAL | Fixed Ragdoll TP | Full Visual Settings | All Side Buttons Draggable | Fixed Hide Buttons | Fixed Side Swap Button
...
-- Visual Tab (إعدادات كاملة - تم إصلاح أزرار Hide)
...
print("H2N V9.8 - FINAL | All fixes applied: Hide buttons working, Side swap button working, Ragdoll TP toggle working")