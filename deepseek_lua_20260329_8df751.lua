-- H2N V9.9 | Ultimate Edition | Fixed Toggles | No BodyGyro | Drag Title Only | No Delay
...
-- ====== AUTO DUEL (بدون أي انتظار، مسافة كشف 0.6) ======
...
-- ====== MAKE TOGGLE (تم الإصلاح - نفس طريقة السكربت التجريبي) ======
...
initWPParts()
ApplyLoadedState()
Notify("H2N V9.9 | Fixed Toggles | No BodyGyro | Drag Title Only | No Delay")
print("=" .. string.rep("=", 60))
