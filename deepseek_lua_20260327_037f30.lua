-- H2N V9.8 | Modified | Anti-Ragdoll from Plasma | Auto Duel with Stops | Unwalk | Full Save
...
-- ====== ANTI RAGDOLL (من Plasma - Motor6D fix) ======
...
-- ====== RAGDOLL TP (معدل - ينقل R1→R2 ويبدأ من R2) ======
...
print("H2N V9.8 - Modified | Anti-Ragdoll from Plasma | Unwalk | Full Save")