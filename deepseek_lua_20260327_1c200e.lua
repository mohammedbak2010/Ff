-- H2N V9.8 | Delta Mobile | Simple Anti-Ragdoll + Auto Taunt + Ragdoll TP
...
-- ====== AUTO TAUNT (عند الفوز في الدولز) ======
...
-- ====== ANTI RAGDOLL (بسيط وشغال على دلتا) ======
...
initWPParts()
Notify("H2N V9.8 | Delta Mobile | Anti-Ragdoll + Auto Taunt + Ragdoll TP")