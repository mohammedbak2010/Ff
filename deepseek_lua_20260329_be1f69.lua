-- H2N V9.9 | Ultimate Edition | Full Working GUI
...
-- ====== RAGDOLL TP ======
local DuelTP = {
    Enabled = false, MyHome = nil, EnemySide = "RIGHT", HomeSet = false,
...
local function LoadEverything()
    ...
    menuW = data.menuW or menuW
    menuH = data.menuH or menuH
...
initWPParts()
ApplyLoadedState()
Notify("H2N V9.9 | Full Working GUI | No Delay Auto Duel")
print("=" .. string.rep("=", 60))
print("📌 H2N V9.9 - ALL FEATURES WORKING:")
print("✓ Auto Play Left: L1 → L2 → L1 → R1 → R2")
print("✓ Auto Play Right: R1 → R2 → R1 → L1 → L2")
print("✓ Auto Track with Head Aim")
print("✓ Auto Grab with Progress Bar")
print("✓ Anti Ragdoll, Infinite Jump, RAGDOLL TP, FLOAT")
print("✓ ESP, Xray Base, Anti Sentry, Spin Body")
print("✓ All Side Buttons with Text Visible")
print("✓ Full Menu with 4 Tabs")
print("=" .. string.rep("=", 60))