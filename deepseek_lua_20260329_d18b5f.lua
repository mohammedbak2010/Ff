-- H2N V9.9 | Ultimate Edition | No Speed Boost | Float Fixed | Auto Duel Fixed (Smooth)
...
-- ====== INIT ======
initWPParts()
Notify("H2N V9.9 | No Speed Boost | Float Fixed | Auto Duel Smooth")
Notify("✓ Auto Duel Fixed - Smooth path movement with waiting system")
...
print("✓ تم إصلاح Auto Duel - نظام انتظار سلس")
print("=" .. string.rep("=", 50))