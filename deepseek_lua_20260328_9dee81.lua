-- H2N V9.8 | Fixed | Ragdoll TP with stops | Auto Dues Fast & Smooth | Full Save
...
local DUEL_APPROACH_SPD = 80  -- زيادة السرعة
local DUEL_RETURN_SPD = 50     -- زيادة سرعة الرجوع
...
-- ====== AUTO DUEL (سريع وسلس بدون توقفات) ======
...
-- ====== RAGDOLL TP (مع توقفات 0.1 عند L1/R1 و 0.2 عند L2/R2) - لا تغيير ======
...
-- ====== SIDE BUTTONS (أزرار جانبية منفصلة) ======
...
-- إنشاء الأزرار الجانبية (كل زر منفصل)
...
print("H2N V9.8 - Fixed | Auto Dues Fast & Smooth | Ragdoll TP & FLOAT separate | All side buttons work")