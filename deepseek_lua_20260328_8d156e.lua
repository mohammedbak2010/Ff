...
-- ====== Side Buttons (6 أزرار منفصلة - كل زر يتحرك لحاله) ======
...
-- زر RAGDOLL TP الجانبي (منفصل وبيتحرك)
do
    ...
    -- إضافة نفس نظام السحب لباقي الأزرار
    local pressing, hasMoved, dragStart, btnStart, activeInput = false, false, nil, nil, nil
    ...
    -- جعل الزر الرئيسي يضغط (يفعل Ragdoll TP)
...
print("H2N V9.8 - Fixed | Auto Dues Original | Ragdoll TP with stops (0.1s/0.2s) | All side buttons draggable")