-- H2N V9.8 | Modified | Anti-Ragdoll + Float from K7 | Auto Duel with Stops
...
MakeKeybind(sTab, "Float Key", "Float", si); si = si + 1
...
print("H2N V9.8 - Modified | Anti-Ragdoll & Float from K7 | Auto Duel with stops | Unwalk | Swap Button")