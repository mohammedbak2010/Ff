-- H2N V9.9 | Complete Edition | Auto Duel Fixed | No Speed Boost
...
-- Create side buttons (بدون Speed Boost وبدون Anti Ragdoll)
...
-- ====== INIT ======
initWPParts()
Notify("H2N V9.9 | Complete Edition | Auto Duel Fixed")
print("=" .. string.rep("=", 50))
