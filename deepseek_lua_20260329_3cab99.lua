-- H2N V9.9 | Ultimate Edition | No Speed Boost | Float Fixed
...
-- ====== ANTI RAGDOLL (فقط في المينيو، بدون زر جانبي) ======
...
-- ====== SIDE BUTTONS (بدون Speed Boost وبدون Anti Ragdoll) ======
...
-- Create all side buttons (بدون Speed Boost وبدون Anti Ragdoll)
...
-- ====== MAIN HEARTBEAT (بدون Speed Boost) ======
...
-- ====== INIT ======
initWPParts()
Notify("H2N V9.9 | No Speed Boost | Float Fixed")
Notify("✓ Auto Duel Fixed - Full path movement")
Notify("✓ Ragdoll TP: Stand 1.5s in base to set home")

print("=" .. string.rep("=", 50))
print("📌 H2N V9.9 - التعديلات:")
print("✓ تم حذف Speed Boost نهائياً")
print("✓ Anti Ragdoll موجود فقط في القائمة (بدون زر جانبي)")
print("✓ تم استبدال كود Float بالكود الجديد")
print("=" .. string.rep("=", 50))