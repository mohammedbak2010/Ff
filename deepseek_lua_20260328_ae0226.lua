-- H2N V9.8 | FINAL | Fixed Ragdoll TP | Full Visual Settings | All Side Buttons Draggable
...
-- ====== RAGDOLL TP (توقفات فقط عند النقل) ======
...
-- ====== زر RAGDOLL TP الجانبي (مع زر L/R يعمل بشكل صحيح) ======
do
    ...
    -- زر تغيير الاتجاه (L/R) - يعمل بشكل صحيح (ضغطة = تبديل ويثبت)
    ...
    -- SWAP: عند الضغط يبدل الاتجاه ويثبت (ما بيرجع لما نشيل الاصبع)
...
print("H2N V9.8 - FINAL | Ragdoll TP stops: L1/R1=0.2, L2/R2=0.15 | Auto Duel smooth | All side buttons draggable | SWAP fixed | Full Visual settings")